                ...
                <div class="card-body">
                    <div id="table-scroll" class="table-scroll">
                        <div class="table-wrap">
                            ...
                            <thead>
                                <tr>
                                    <th class="fixed-side" scope="col">View</th>
                                    <th class="fixed-side" scope="col">Edit</th>
                                    <th class="fixed-side" scope="col">Print</th>
                            ...
                            <tbody>
                                @foreach ($documents as $document )
                                    <tr class="{{ $document->D_DateOut || $document->D_fileno ? '' : 'highlighted' }}" >
                                        ...
                                        <th class="fixed-side"><a href="/document/view/{{ $document->id }}"> Edit </a></th>
                                        <th class="fixed-side"><a href="/document/print/{{ $document->id }}">Print </a></th>
                                        <th class="fixed-side"> 
                                        ...
                                        <th class="fixed-side"> 
                                            <p class="my-0" data-toggle="tooltip" data-placement="top" title="{{ $document->D_LetterNo }}" > 
                                                {{ substr($document->D_LetterNo, 0, 25) }} {{ strlen($document->D_LetterNo) > 25 ? '...' : '' }}
                                            </p>
