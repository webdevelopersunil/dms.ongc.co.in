...
@section('content')
    ...
    <div class="container mt-fit px-0 shadow" >
        ...
        <div class="p-2 mb-4 bg-lightblue">
            <form action="/disha/{{ $document->id }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card p-2" >
                    <div class="row">
                        <div class="col-2">
                ...
                <div class="px-4 py-4">
                    ...
                    <button type="submit" formaction="/disha/{{ $document->id }}" class="btn dms-btn-primary mx-1 px-4">Save</button>
                    <a href="/disha" class="btn dms-btn-primary mx-1 px-4">Cancel</a>
